...
import 'package:service365_admin_panel/landing_screen/service_management/service_details_screen/cook_details_screen.dart';
import 'package:service365_admin_panel/landing_screen/service_management/service_details_screen/driver_details_screen.dart';
import 'package:service365_admin_panel/landing_screen/service_management/service_details_screen/electri_details_screen.dart';
import 'package:service365_admin_panel/landing_screen/service_management/service_details_screen/maid_details_screen.dart';
import 'package:service365_admin_panel/landing_screen/service_management/service_details_screen/plumber_details_screen.dart';
...
class _ServiceManagementState extends State<ServiceManagement> {
  ...
  Future<void> screenNavigator(String? serviceName, index, logs) async {
    switch (serviceName) {
      case "Maid":
        Navigator.push(
          context,
      ...
      case "Electrician":
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const ElecDetailsScreen(),
          ),
        );
        break;
      case "Plumber":
