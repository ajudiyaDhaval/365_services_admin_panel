...
class AddDiscountDialogWidget extends StatefulWidget {
  const AddDiscountDialogWidget({Key? key}) : super(key: key);

  @override
  State<AddDiscountDialogWidget> createState() =>
      _AddDiscountDialogWidgetState();
}

class _AddDiscountDialogWidgetState extends State<AddDiscountDialogWidget> {
  ...
  Future<void> _submit() async {
    if (!_formKey.currentState!.validate() || _pickedImageModel == null) {
      ...
      await BlocProvider.of<BannerManagementCubit>(context).addDiscount(
        context: context,
        advertisementModel: AdvertisementModel(name: _nameController.text),
